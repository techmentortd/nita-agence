...
export const TR = {
  fr: {
    ...
    map_dl_downloading: 'Téléchargement de la carte et des itinéraires…',
    map_dl_available: 'Carte et itinéraires disponibles hors ligne ({n} tuiles)',
    map_dl_retry: 'Échec — réessayer',
    map_dl_download: 'Télécharger la carte et les itinéraires hors ligne',
    ...
    map_filters: 'Filtres',
    map_expand_hint: 'Glisser vers le haut pour voir plus d\'agences',
    map_following_on: 'Suivi en direct',
    map_following_off: 'Suivre ma position',
  ...
  ar: {
    ...
    map_dl_downloading: 'جارٍ تنزيل الخريطة ومسارات الطرق…',
    map_dl_available: 'الخريطة ومسارات الطرق متاحة دون اتصال ({n} بلاطة)',
    map_dl_retry: 'فشل — إعادة المحاولة',
    map_dl_download: 'تنزيل الخريطة ومسارات الطرق للاستخدام دون اتصال',
    ...
    map_filters: 'عوامل التصفية',
    map_expand_hint: 'اسحب لأعلى لرؤية المزيد من الوكالات',
    map_following_on: 'التتبع المباشر مفعّل',
    map_following_off: 'تتبع موقعي',
